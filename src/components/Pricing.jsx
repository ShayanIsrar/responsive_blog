    ...
    const packages = [
        {
            ...
            green: '/src/assets/Rectangle18.svg',
            pink: '/src/assets/Rectangle20.svg'
        },
        {
            name: 'Advance', 
            monthlyPrice: 39,
      ...
      <motion.div variants={fadeIn('up', 0.2)} initial={'hidden'} whileInView={'show'} viewport={{once:false, amount:0.2}} className='grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto'>
        {
            packages.map((pkg, index)=> <div key={index} className='border py-10 md:px-6 px-4 rounded-lg shadow-3xl'>
                ...
                <ul className='mt-4 space-y-2 px-4'>
                    ...
                    <li className='flex gap-3 items-center'><img src={pkg.pink} alt="" className='w-4 h-4'/> Additional practical task</li>
                    <li className='flex gap-3 items-center'><img src={pkg.pink} alt="" className='w-4 h-4'/> Monthly conferences</li>
                    <li className='flex gap-3 items-center'><img src={pkg.pink} alt="" className='w-4 h-4'/> Personal advice from teachers</li>
                </ul>
